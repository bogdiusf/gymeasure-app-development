            ...
            <Modal.Body>
                ...
                <InputGroup className="mb-3" style={{ justifyContent: 'center' }}>
                    <InputGroup.Prepend style={{ display: 'grid', gridTemplateColumns: '0.5fr 2.5fr', margin: 'auto' }}>
                        ...
                        <FormControl ref={props.editChestRef} defaultValue={props.chestEdited} onChange={() => props.setIsSaveMeasurementChangesEnabled(true)} />
                        <InputGroup.Text>Arms</InputGroup.Text>
                        <FormControl ref={props.editArmsRef} defaultValue={props.armsEdited} onChange={() => props.setIsSaveMeasurementChangesEnabled(true)} />
                        <InputGroup.Text>Quads</InputGroup.Text>
                        <FormControl ref={props.editQuadsRef} defaultValue={props.quadsEdited} onChange={() => props.setIsSaveMeasurementChangesEnabled(true)} />
                    </InputGroup.Prepend>
                </InputGroup>
                <Modal.Footer>
